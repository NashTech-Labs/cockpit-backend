...
@Component({
  selector: 'app-statefullset',
  templateUrl: './statefullset.component.html',
  styleUrls: ['./statefullset.component.scss']
})
export class StatefullsetComponent implements OnInit {
  check: boolean = false
