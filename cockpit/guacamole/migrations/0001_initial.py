    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proxy_encryption_method', models.TextField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('connection', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='guacamole.guacamoleconnection')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('connection_group', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='guacamole.guacamoleconnectiongroup')),
                ('attribute_name', models.CharField(max_length=128)),
                ('attribute_value', models.CharField(max_length=4096)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('entity', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='guacamole.guacamoleentity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('sharing_profile', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='guacamole.guacamolesharingprofile')),
                ('attribute_name', models.CharField(max_length=128)),
                ('attribute_value', models.CharField(max_length=4096)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='guacamole.guacamoleuser')),
                ('attribute_name', models.CharField(max_length=128)),
                ('attribute_value', models.CharField(max_length=4096)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_group', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='guacamole.guacamoleusergroup')),
                ('attribute_name', models.CharField(max_length=128)),
                ('attribute_value', models.CharField(max_length=4096)),
            ],
            options={
